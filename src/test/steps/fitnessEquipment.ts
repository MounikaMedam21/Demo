...
import { FitnessEquipmentPage } from '../../pages/fitnessEquipmentPage'; // Adjust import path as necessary
...
When('User clicks on the dropdown', async function (optionText: string) {
